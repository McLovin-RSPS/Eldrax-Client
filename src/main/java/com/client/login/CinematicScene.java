...
public class CinematicScene {
	...
	private void setupCamera() {
		...
		for(int i = 0;i<1;i++) {
			...
			otherCameraMove
			.startInformation(Vector3.of(2816, 287, -3181), 0, 156)
			.add(CameraFrame
					.builder()
					.targetLocation(Vector3.of(2816, 2804, -1309))
					.rotation(0)
					.tilt(101)
					.frames(652)
					.build()
			...
			.add(CameraFrame
					.builder()
					.targetLocation(Vector3.of(2816, 5365, -840))
					.rotation(0)
					.tilt(101)
					.frames(652)
					.build()
			...
			.add(CameraFrame
					.builder()
					.targetLocation(Vector3.of(2816, 5565, -840))
					.rotation(0)
					.tilt(71)
					.frames(100)
					.build()
			...
			.add(CameraFrame
					.builder()
					.targetLocation(Vector3.of(2816, 6995, -840))
					.rotation(0)
					.tilt(51)
					.frames(652)
					.build()
			...
			.add(CameraFrame
					.builder()
					.targetLocation(Vector3.of(2816, 6495, -840))
					.rotation(0)
					.tilt(51)
					.frames(100)
					.build()
			...
			.add(CameraFrame
					.builder()
					.targetLocation(Vector3.of(2816, 5165, -1200))
					.rotation(0)
					.tilt(101)
					.frames(652)
					.build()
