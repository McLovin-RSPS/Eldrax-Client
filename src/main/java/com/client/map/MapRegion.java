...
public class MapRegion {
						...
						if (underlayA > 0 || overlayA > 0) {
							...
							if (overlayA == 0) {
								...
								if (minimapColor == 0x000000 && def_over.anotherRgb != -1) {
									int newMinimapColor = encode(def_over.anotherHue, def_over.anotherSaturation, def_over.anotherSaturation);
	...
	private void renderObject(int y, SceneGraph worldController, CollisionMap class11, int type, int z, int x,
		...
		if (type == 22) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj = new AnimatedGameObject(id, orientation, 22, l1, i2, k1, j2, definition.animation, true);
		...
		if (type == 10 || type == 11) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj1 = new AnimatedGameObject(id, orientation, 10, l1, i2, k1, j2, definition.animation, true);
			if (obj1 != null) {
				int i5 = 0;
				if (type == 11)
					i5 += 256;
		...
		if (type >= 12) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj2 = new AnimatedGameObject(id, orientation, type, l1, i2, k1, j2, definition.animation, true);
		...
		if (type == 0) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj3 = new AnimatedGameObject(id, orientation, 0, l1, i2, k1, j2, definition.animation, true);
		...
		if (type == 1) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj4 = new AnimatedGameObject(id, orientation, 1, l1, i2, k1, j2, definition.animation, true);
		...
		if (type == 2) {
			...
			if (definition.animation == -1 && definition.morphisms == null) {
				...
				obj11 = new AnimatedGameObject(id, 4 + orientation, 2, l1, i2, k1, j2, definition.animation, true);
				obj12 = new AnimatedGameObject(id, i3, 2, l1, i2, k1, j2, definition.animation, true);
			}
		...
		if (type == 3) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj5 = new AnimatedGameObject(id, orientation, 3, l1, i2, k1, j2, definition.animation, true);
		...
		if (type == 9) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj6 = new AnimatedGameObject(id, orientation, type, l1, i2, k1, j2, definition.animation, true);
		...
		if (type == 4) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj7 = new AnimatedGameObject(id, 0, 4, l1, i2, k1, j2, definition.animation, true);
		...
		if (type == 5) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj13 = new AnimatedGameObject(id, 0, 4, l1, i2, k1, j2, definition.animation, true);
		...
		if (type == 6) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj8 = new AnimatedGameObject(id, 0, 4, l1, i2, k1, j2, definition.animation, true);
		...
		if (type == 7) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj9 = new AnimatedGameObject(id, 0, 4, l1, i2, k1, j2, definition.animation, true);
		...
		if (type == 8) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj10 = new AnimatedGameObject(id, 0, 4, l1, i2, k1, j2, definition.animation, true);
	...
	public final void decodeConstructedMapsLandscape(int i, int j, CollisionMap aclass11[], int l, int i1, byte abyte0[], int j1, int k1,
			int l1) {
		for (int i2 = 0; i2 < 8; i2++) {
			for (int j2 = 0; j2 < 8; j2++)
				if (l + i2 > 0 && l + i2 < regionSizeX - 1 && l1 + j2 > 0 && l1 + j2 < regionSizeY - 1)
			...
			for (int i3 = 0; i3 < 64; i3++) {
				for (int j3 = 0; j3 < 64; j3++)
					if (l2 == i && i3 >= i1 && i3 < i1 + 8 && j3 >= j1 && j3 < j1 + 8)
						decodeLandscape(l1 + TiledUtils.getRotatedLandscapeChunkY(j3 & 7, j, i3 & 7), 0, stream,
								l + TiledUtils.getRotatedLandscapeChunkX(j, j3 & 7, i3 & 7), k1, j, 0);
					else
						decodeLandscape(-1, 0, stream, -1, 0, 0, 0);
	...
	public final void decodeLandscapeFile(byte abyte0[], int offsetY, int offsetX, int baseX, int baseY, CollisionMap aclass11[]) {
		...
		for (int z = 0; z < 4; z++) {
			for (int x = 0; x < 64; x++) {
				for (int y = 0; y < 64; y++)
					decodeLandscape(y + offsetY, baseY, stream, x + offsetX, z, 0, baseX);
	...
	private void decodeLandscape(int i, int j, Buffer stream, int k, int l, int i1, int baseX) {
		try {
	...
	public final void decodeConstructedMapObjects(CollisionMap aclass11[], SceneGraph worldController, int i, int j, int k, int l,
			...
			do {
				...
				do {
					...
					if (j3 == i && i3 >= i1 && i3 < i1 + 8 && l2 >= k && l2 < k + 8) {
						...
						int j4 = j + TiledUtils.getRotatedMapChunkX(j1, class46.length, i3 & 7, l2 & 7, class46.width);
						int k4 = k1 + TiledUtils.getRotatedMapChunkY(l2 & 7, class46.length, j1, class46.width, i3 & 7);
