...
public final class Player extends Entity {
	...
	public Model getRotatedModel() {
		...
		if(super.anInt1520 >= GraphicsDefinition.cache.length)
			super.anInt1520 = -1;
		...
		if (super.anInt1520 != -1 && super.anInt1521 != -1) {
			...
			if(spotAnim != null) {
				...
				if (model_2 != null) {
					...
					model_3.createBones();
					model_3.applyTransform(spotAnim.animation.primaryFrames[super.anInt1521]);
					model_3.faceGroups = null;
					model_3.vertexGroups = null;
					if (spotAnim.breadthScale != 128 || spotAnim.depthScale != 128)
						model_3.scale(spotAnim.breadthScale, spotAnim.breadthScale,
								spotAnim.depthScale);
	...
	public Model method452() {
		...
		if (model_1 == null) {
			...
			for (int j3 = 0; j3 < 5; j3++)
				if (playerAppearance[j3] != 0) {
					model_1.replaceColor(Client.anIntArrayArray1003[j3][0],
							Client.anIntArrayArray1003[j3][playerAppearance[j3]]);
					if (j3 == 1)
						model_1.replaceColor(Client.anIntArray1204[0],
								Client.anIntArray1204[playerAppearance[j3]]);
				}
		...
		if (k != -1 && i1 != -1)
			model_2.mixAnimationFrames(AnimationDefinition.anims[super.anim].interleaveOrder, i1, k);
		else if (k != -1)
	...
	public Model method453() {
		...
		for (int j1 = 0; j1 < 5; j1++)
			if (playerAppearance[j1] != 0) {
				model.replaceColor(Client.anIntArrayArray1003[j1][0],
						Client.anIntArrayArray1003[j1][playerAppearance[j1]]);
				if (j1 == 1)
					model.replaceColor(Client.anIntArray1204[0],
							Client.anIntArray1204[playerAppearance[j1]]);
			}
	...
	public final int[] playerAppearance;
	public int team;
	private int gender;
	public String name;
