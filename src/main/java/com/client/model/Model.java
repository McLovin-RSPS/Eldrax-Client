...
public class Model extends Renderable {
    ...
    public Model(int model) {
        ...
        if (data[data.length - 1] == -1 && data[data.length - 2] == -1) {
            ...
            readOldModel(model);
            int[] priorityFix = new int[] {91208,91209,800013,800012,800011,800010,800014,800015,800016,800017,800018,800019,800020,800021,83130,83131,83132,83133,83134,83145,83146,83137,
            							   95128,95129,95130,95131,95132,95133,95134,95135,95136,95137,95138,94133,94134,94135,94136,94137,94138,94139};
	...
	public void method1337(final int j) {
    ...
    public static void method459(int i, ResourceProvider onDemandFetcherParent) {
        aClass21Array1661 = new ModelHeader[900000];
        newmodel = new boolean[900000];
    ...
    public void mixAnimationFrames(int ai[], int j, int k) {
        if (k == -1) {
            return;
        }
        if (ai == null || j == -1) {
